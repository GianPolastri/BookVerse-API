...
const addToCartHandler = async (req, res) => {
    const { user_id, book_id, quantity } = req.query;
    try {
        const addedProduct = await addToCart( user_id, book_id, quantity );
...
const changeQuantityHandler = async (req, res) => {
    const { user_id, book_id, quantity } = req.query;
    try {
        const changedProduct = await changeQuantity(user_id, book_id, quantity);
