...
const BooksTest = [
    ...
    },
    {
        ...
        "price": 20,
        "description": "Amanecer de 1945. Un muchacho es conducido por su padre a unmisterioso lugar oculto en el corazon de la ciudad vieja: ElCementerio de los Libros Olvidados. Alli, Daniel Sempere encuentra un libro maldito que cambia el rumbo de su vida y lo arrastra a un laberinto de intrigasy secretos enterrados en el alma oscura de la ciudad. La Sombra del Viento es un misterio literario ambientado en la Barcelona de la primera mitad del siglo xx, desde los ultimos esplendores del Modernismo hasta las tinieblas de laposguerra.",
        "pages": 545,
    ...
    },
    {
        ...
        "author": "Carlos Ruiz Zafón",
        "price": 27,
        "description": "En la turbulenta Barcelona de los a\os 1920 un joven escritor obsesionado con un amor imposible escritor recibe la oferta de un misterioso editor para escribir un libro como no ha existido nunca, a cambio de una fortuna y, tal vez, mucho mas. Con estilo deslumbrante e impecable precision narrativa, el autor de La Sombra del Viento nos transporta de nuevo a la Barcelona del Cementerio de los Libros Olvidados para ofrecernos una aventura de intriga, romance y tragedia, a traves de un laberinto de secretos donde el embrujo de los libros, la pasion y la amistad se conjugan en un relato magistral.",
        "pages": 688,
    ...
    },
    {
        ...
        "author": "J.R.R. Tolkien",
        "price": 29,
        "description": "Es la primera obra que explora el universo mitológico creado por Tolkien y que más tarde se encargarían de definir El Señor de los Anillos y El Silmarillion. Dentro de dicha ficción, el argumento de El hobbit se sitúa en el año 2941 de la Tercera Edad del Sol, y narra la historia del hobbit Bilbo Bolsón, que junto con el mago Gandalf y un grupo de enanos, vive una aventura en busca del tesoro custodiado por el dragón Smaug en la Montaña Solitaria.",
        "pages": 320,
    ...
    },
    {
        ...
        "author": "J.R.R. Tolkien",
        "price": 28,
        "description": "El Silmarillion cuenta la historia de la Primera Edad, el antiguo drama del que hablan los personajes de El Se\or de los Anillos, y en cuyos acontecimientos algunos de ellos tomaron parte, como Elrond y Galadriel... Una obra de autentica imaginacion, una vision inspirada, legendaria o mitica, del interminable conflicto entre el deseo de poder yla capacidad de crear. Edicion revisada del clasico Silmarillion del gran J. R. R. Tolkien.",
        "pages": 552,
